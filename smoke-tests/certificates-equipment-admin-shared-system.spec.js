...
test("Certificate and Equipment admin views use scoped token-only extensions", async () => {
  ...
  expect(adminPage).toContain('equipment-admin.css?v=3');
  expect(adminPage).toContain('admin.css?v=18');
  ...
  for (const asset of ["certificates-admin.css?v=1", "certificates-embedded.css?v=1", "equipment-admin.css?v=3", "admin.css?v=18", "admin-certificates.js?v=4", "admin-equipment.js?v=2"]) {
