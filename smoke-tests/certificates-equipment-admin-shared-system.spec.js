...
test("Certificate and Equipment admin views use scoped token-only extensions", async () => {
  ...
  expect(adminPage).toContain('admin.css?v=17');
  ...
  for (const asset of ["certificates-admin.css?v=1", "certificates-embedded.css?v=1", "equipment-admin.css?v=2", "admin.css?v=17", "admin-certificates.js?v=4", "admin-equipment.js?v=2"]) {
