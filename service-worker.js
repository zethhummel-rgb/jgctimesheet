...
const JGC_APP_SHELL = [
  ...
  "./styles.css?v=3",
  "./admin.css?v=16",
  "./admin-shell-design-system.css?v=1",
  "./inspection-history-today.css?v=1",
  "./inspection-history-previous.css?v=1",
  "./safety-records-admin.css?v=1",
  "./admin-global-search.css?v=6",
  ...
  "./work-orders-design-system.css?v=1",
  ...
  "./home-design-system.css?v=3",
  "./notification-settings-design-system.css?v=2",
  "./acknowledgement-design-system.css?v=2",
  "./login-design-system.css?v=2",
  "./common.js?v=39",
  "./admin-global-search.js?v=6",
  ...
  "./estimating/assets/index-B0NN_e4W.js",
  "./estimating/assets/index-Dzcewc4R.css",
  "./estimating/assets/es-CNsl1tv3.js",
  "./estimating/assets/pdf-Cl8BSpz0.js",
  "./estimating/assets/src-D60X9x1A.js",
  "./estimating/assets/proposal-pdf-BoExxyb_.js",
  "./estimating/assets/purchase-order-pdf-B1RmduAp.js",
  "./estimating/assets/quote-backup-pdf-Dvg2CdI4.js",
