  ...
  return <section className="supplier-catalog-block">
    ...
    {manualOpen && <section className="panel manual-material-card" aria-label="Add material manually">
      ...
      <div className="manual-material-grid">
        ...
        <label className="field"><span>Cost</span><div className="input-prefix"><span>$</span><ClearableNumberInput min="0" step="0.001" value={manualDraft.netCost} onValueChange={(value) => setManualDraft({ ...manualDraft, netCost: value ?? 0 })} /></div></label>
